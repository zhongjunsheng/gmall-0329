package member.provider.common.aop;//package member.provider.common.aop;
//
...
//	//@Around("execution(* member.provider.common.aop..*.*(..))")
//	@Around("execution(* member.provider.common.aop.TestUserController..*(..))")
