...
public class WxXinTemplteMessagePush {
    ...
    public void sendTemplateMessageProdByObject() {
        ...
        mt.setTouser("ob1xIwb2VL5E_oLJJVCqHVYVAAqQ"); //openId  --柳州
        mt.setTemplate_id("FK5Y_dlb3FpvfV5o8p6S3cXzN0HgRpQGHCyamgPufZ8"); //模板id --柳州
        mt.setUrl("http://www.baidu.com"); //点击详情跳转url
        MsgData msgData = new MsgData();
        msgData.setFirst(new MsgModel("您有一份新的待办事项，请到pc端进行办理。","#e4393c"));
        msgData.setKeyword1(new MsgModel("msg push test","#000"));
        msgData.setKeyword2(new MsgModel("待办事项","#000"));
